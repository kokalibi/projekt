...
import { t as require_react_dom } from "./react-dom-Cf0Joj94.js";
...
function useIsRSCRouterContext() {
	return import_react$7.useContext(RSCRouterContext);
}
function useHref(to, { relative } = {}) {
	invariant(useInRouterContext(), `useHref() may be used only in the context of a <Router> component.`);
	let { basename, navigator } = import_react$8.useContext(NavigationContext);
...
function useInRouterContext() {
	return import_react$8.useContext(LocationContext) != null;
}
function useLocation() {
	invariant(useInRouterContext(), `useLocation() may be used only in the context of a <Router> component.`);
	return import_react$8.useContext(LocationContext).location;
}
function useNavigationType() {
	return import_react$8.useContext(LocationContext).navigationType;
}
function useMatch(pattern) {
	invariant(useInRouterContext(), `useMatch() may be used only in the context of a <Router> component.`);
	let { pathname } = useLocation();
	return import_react$8.useMemo(() => matchPath(pattern, decodePath(pathname)), [pathname, pattern]);
}
function useIsomorphicLayoutEffect(cb) {
	if (!import_react$8.useContext(NavigationContext).static) import_react$8.useLayoutEffect(cb);
}
function useNavigate() {
	let { isDataRoute } = import_react$8.useContext(RouteContext);
	return isDataRoute ? useNavigateStable() : useNavigateUnstable();
}
function useNavigateUnstable() {
	invariant(useInRouterContext(), `useNavigate() may be used only in the context of a <Router> component.`);
	let dataRouterContext = import_react$8.useContext(DataRouterContext);
	let { basename, navigator } = import_react$8.useContext(NavigationContext);
	let { matches } = import_react$8.useContext(RouteContext);
	let { pathname: locationPathname } = useLocation();
	let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
	let activeRef = import_react$8.useRef(false);
	useIsomorphicLayoutEffect(() => {
		activeRef.current = true;
	});
	return import_react$8.useCallback((to, options = {}) => {
...
function useOutletContext() {
	return import_react$8.useContext(OutletContext);
}
function useOutlet(context) {
	let outlet = import_react$8.useContext(RouteContext).outlet;
	return import_react$8.useMemo(() => outlet && /* @__PURE__ */ import_react$8.createElement(OutletContext.Provider, { value: context }, outlet), [outlet, context]);
}
function useParams() {
	let { matches } = import_react$8.useContext(RouteContext);
...
function useResolvedPath(to, { relative } = {}) {
	...
	let { pathname: locationPathname } = useLocation();
	let routePathnamesJson = JSON.stringify(getResolveToMatches(matches));
	return import_react$8.useMemo(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [
		to,
		routePathnamesJson,
		locationPathname,
		relative
...
function useRoutesImpl(routes, locationArg, dataRouterState, unstable_onError, future) {
	...
	let { navigator } = import_react$8.useContext(NavigationContext);
	let { matches: parentMatches } = import_react$8.useContext(RouteContext);
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
	...
	if (locationArg && renderedMatches) return /* @__PURE__ */ import_react$8.createElement(LocationContext.Provider, { value: {
		location: {
			pathname: "/",
			search: "",
			hash: "",
...
function DefaultErrorComponent() {
	...
	if (ENABLE_DEV_WARNINGS) {
		...
		devInfo = /* @__PURE__ */ import_react$8.createElement(import_react$8.Fragment, null, /* @__PURE__ */ import_react$8.createElement("p", null, "💿 Hey developer 👋"), /* @__PURE__ */ import_react$8.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /* @__PURE__ */ import_react$8.createElement("code", { style: codeStyles }, "ErrorBoundary"), " or", " ", /* @__PURE__ */ import_react$8.createElement("code", { style: codeStyles }, "errorElement"), " prop on your route."));
	}
	return /* @__PURE__ */ import_react$8.createElement(import_react$8.Fragment, null, /* @__PURE__ */ import_react$8.createElement("h2", null, "Unexpected Application Error!"), /* @__PURE__ */ import_react$8.createElement("h3", { style: { fontStyle: "italic" } }, message), stack ? /* @__PURE__ */ import_react$8.createElement("pre", { style: preStyles }, stack) : null, devInfo);
}
function RenderedRoute({ routeContext, match, children }) {
	let dataRouterContext = import_react$8.useContext(DataRouterContext);
	if (dataRouterContext && dataRouterContext.static && dataRouterContext.staticContext && (match.route.errorElement || match.route.ErrorBoundary)) dataRouterContext.staticContext._deepestRenderedBoundaryId = match.route.id;
	return /* @__PURE__ */ import_react$8.createElement(RouteContext.Provider, { value: routeContext }, children);
}
function _renderMatches(matches, parentMatches = [], dataRouterState = null, unstable_onError = null, future = null) {
	...
	return renderedMatches.reduceRight((outlet, match, index) => {
		...
		let getChildren = () => {
			...
			else if (match.route.Component) children = /* @__PURE__ */ import_react$8.createElement(match.route.Component, null);
			else if (match.route.element) children = match.route.element;
			else children = outlet;
			return /* @__PURE__ */ import_react$8.createElement(RenderedRoute, {
				match,
				routeContext: {
					outlet,
					matches: matches2,
		...
		return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? /* @__PURE__ */ import_react$8.createElement(RenderErrorBoundary, {
			location: dataRouterState.location,
...
function useDataRouterContext(hookName) {
	let ctx = import_react$8.useContext(DataRouterContext);
	invariant(ctx, getDataRouterConsoleError(hookName));
	return ctx;
}
function useDataRouterState(hookName) {
	let state = import_react$8.useContext(DataRouterStateContext);
	invariant(state, getDataRouterConsoleError(hookName));
	return state;
}
function useRouteContext(hookName) {
	let route = import_react$8.useContext(RouteContext);
...
function useRevalidator() {
	...
	let revalidate = import_react$8.useCallback(async () => {
...
function useMatches() {
	...
	return import_react$8.useMemo(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
...
function useRouteError() {
	let error = import_react$8.useContext(RouteErrorContext);
...
function useAsyncValue() {
	return import_react$8.useContext(AwaitContext)?._data;
}
function useAsyncError() {
	return import_react$8.useContext(AwaitContext)?._error;
}
function useBlocker(shouldBlock) {
	let { router: router$1, basename } = useDataRouterContext("useBlocker");
	let state = useDataRouterState("useBlocker");
	let [blockerKey, setBlockerKey] = import_react$8.useState("");
	let blockerFunction = import_react$8.useCallback((arg) => {
...
function useNavigateStable() {
	...
	return import_react$8.useCallback(async (to, options = {}) => {
		warning(activeRef.current, navigateEffectWarning);
		if (!activeRef.current) return;
...
function mapRouteProperties(route) {
	...
	if (route.Component) {
		...
		Object.assign(updates, {
			element: import_react$9.createElement(route.Component),
			Component: void 0
		});
	}
	if (route.HydrateFallback) {
		...
		Object.assign(updates, {
			hydrateFallbackElement: import_react$9.createElement(route.HydrateFallback),
	...
	if (route.ErrorBoundary) {
		...
		Object.assign(updates, {
			errorElement: import_react$9.createElement(route.ErrorBoundary),
...
function UNSTABLE_TransitionEnabledRouterProvider({ router: router$1, flushSync: reactDomFlushSyncImpl, unstable_onError }) {
	let fetcherData = import_react$9.useRef(/* @__PURE__ */ new Map());
	let [revalidating, startRevalidation] = import_react$9.useTransition();
	let [state, setState] = import_react$9.useState(router$1.state);
	...
	let navigator = import_react$9.useMemo(() => {
		return {
	...
	let dataRouterContext = import_react$9.useMemo(() => ({
		router: router$1,
		navigator,
		static: false,
		basename,
	...
	import_react$9.useLayoutEffect(() => {
		return router$1.subscribe((newState, { deletedFetchers, flushSync, viewTransitionOpts }) => {
			...
			else import_react$9.startTransition(() => {
				setState(newState);
			});
		});
	}, [
	...
	return /* @__PURE__ */ import_react$9.createElement(import_react$9.Fragment, null, /* @__PURE__ */ import_react$9.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ import_react$9.createElement(DataRouterStateContext.Provider, { value: {
		...state,
		revalidation: revalidating ? "loading" : state.revalidation
	} }, /* @__PURE__ */ import_react$9.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ import_react$9.createElement(Router, {
		basename,
		location: state.location,
		navigationType: state.historyAction,
		navigator
	}, /* @__PURE__ */ import_react$9.createElement(MemoizedDataRoutes, {
...
function RouterProvider({ router: router$1, flushSync: reactDomFlushSyncImpl, unstable_onError }) {
	let [state, setStateImpl] = import_react$9.useState(router$1.state);
	let [pendingState, setPendingState] = import_react$9.useState();
	let [vtContext, setVtContext] = import_react$9.useState({ isTransitioning: false });
	let [renderDfd, setRenderDfd] = import_react$9.useState();
	let [transition, setTransition] = import_react$9.useState();
	let [interruption, setInterruption] = import_react$9.useState();
	let fetcherData = import_react$9.useRef(/* @__PURE__ */ new Map());
	let logErrorsAndSetState = import_react$9.useCallback((newState) => {
	...
	let setState = import_react$9.useCallback((newState, { deletedFetchers, flushSync, viewTransitionOpts }) => {
		newState.fetchers.forEach((fetcher, key) => {
			if (fetcher.data !== void 0) fetcherData.current.set(key, fetcher.data);
		});
		deletedFetchers.forEach((key) => fetcherData.current.delete(key));
		...
		if (!viewTransitionOpts || !isViewTransitionAvailable) {
			...
			else import_react$9.startTransition(() => logErrorsAndSetState(newState));
			return;
		}
	...
	import_react$9.useLayoutEffect(() => router$1.subscribe(setState), [router$1, setState]);
	...
	import_react$9.useEffect(() => {
		if (renderDfd && pendingState && router$1.window) {
			...
			let transition2 = router$1.window.document.startViewTransition(async () => {
				import_react$9.startTransition(() => logErrorsAndSetState(newState));
				await renderPromise;
			});
	...
	return /* @__PURE__ */ import_react$9.createElement(import_react$9.Fragment, null, /* @__PURE__ */ import_react$9.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ import_react$9.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ import_react$9.createElement(FetchersContext.Provider, { value: fetcherData.current }, /* @__PURE__ */ import_react$9.createElement(ViewTransitionContext.Provider, { value: vtContext }, /* @__PURE__ */ import_react$9.createElement(Router, {
		basename,
		location: state.location,
		navigationType: state.historyAction,
		navigator
...
function MemoryRouter({ basename, children, initialEntries, initialIndex }) {
	let historyRef = import_react$9.useRef();
	...
	let [state, setStateImpl] = import_react$9.useState({
		action: history.action,
		location: history.location
	});
	let setState = import_react$9.useCallback((newState) => {
		import_react$9.startTransition(() => setStateImpl(newState));
	}, [setStateImpl]);
	import_react$9.useLayoutEffect(() => history.listen(setState), [history, setState]);
	return /* @__PURE__ */ import_react$9.createElement(Router, {
		basename,
		children,
		location: state.location,
...
function Navigate({ to, replace: replace2, state, relative }) {
	...
	let { static: isStatic } = import_react$9.useContext(NavigationContext);
...
function Router({ basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP", navigator, static: staticProp = false }) {
	...
	let navigationContext = import_react$9.useMemo(() => ({
		basename,
		navigator,
		static: staticProp,
		future: {}
	...
	let locationContext = import_react$9.useMemo(() => {
	...
	return /* @__PURE__ */ import_react$9.createElement(NavigationContext.Provider, { value: navigationContext }, /* @__PURE__ */ import_react$9.createElement(LocationContext.Provider, {
		children,
...
function Await({ children, errorElement, resolve }) {
	...
	let dataRouterStateContext = import_react$9.useContext(DataRouterStateContext);
	let onError = import_react$9.useCallback((error, errorInfo) => {
	...
	return /* @__PURE__ */ import_react$9.createElement(AwaitErrorBoundary, {
		resolve,
		errorElement,
		onError
	}, /* @__PURE__ */ import_react$9.createElement(ResolveAwait, null, children));
}
function ResolveAwait({ children }) {
	let data2 = useAsyncValue();
	let toRender = typeof children === "function" ? children(data2) : children;
	return /* @__PURE__ */ import_react$9.createElement(import_react$9.Fragment, null, toRender);
}
function createRoutesFromChildren(children, parentPath = []) {
	let routes = [];
	import_react$9.Children.forEach(children, (element, index) => {
		if (!import_react$9.isValidElement(element)) return;
		let treePath = [...parentPath, index];
		if (element.type === import_react$9.Fragment) {
...
function WithComponentProps({ children }) {
	...
	return import_react$9.cloneElement(children, props);
}
function withComponentProps(Component4) {
	return function WithComponentProps2() {
		const props = useRouteComponentProps();
		return import_react$9.createElement(Component4, props);
	};
}
...
function withHydrateFallbackProps(HydrateFallback) {
	return function WithHydrateFallbackProps2() {
		const props = useHydrateFallbackProps();
		return import_react$9.createElement(HydrateFallback, props);
	};
}
...
function withErrorBoundaryProps(ErrorBoundary) {
	return function WithErrorBoundaryProps2() {
		const props = useErrorBoundaryProps();
		return import_react$9.createElement(ErrorBoundary, props);
	};
}
...
function StreamTransfer({ context, identifier, reader, textDecoder, nonce }) {
	...
	let scriptTag = value ? /* @__PURE__ */ import_react$10.createElement("script", {
		nonce,
		dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.enqueue(${escapeHtml(JSON.stringify(value))});` }
	}) : null;
	if (done) return /* @__PURE__ */ import_react$10.createElement(import_react$10.Fragment, null, scriptTag, /* @__PURE__ */ import_react$10.createElement("script", {
		nonce,
		dangerouslySetInnerHTML: { __html: `window.__reactRouterContext.streamController.close();` }
	}));
	else return /* @__PURE__ */ import_react$10.createElement(import_react$10.Fragment, null, scriptTag, /* @__PURE__ */ import_react$10.createElement(import_react$10.Suspense, null, /* @__PURE__ */ import_react$10.createElement(StreamTransfer, {
		context,
...
function RemixRootDefaultHydrateFallback() {
	return /* @__PURE__ */ import_react$15.createElement(BoundaryShell, {
		title: "Loading...",
		renderScripts: true
	}, ENABLE_DEV_WARNINGS ? /* @__PURE__ */ import_react$15.createElement("script", { dangerouslySetInnerHTML: { __html: `
              console.log(
...
function getRouteComponents(route, routeModule, isSpaMode) {
	...
	let ErrorBoundary = routeModule.ErrorBoundary ? routeModule.ErrorBoundary : route.id === "root" ? () => /* @__PURE__ */ import_react$14.createElement(RemixRootDefaultErrorBoundary, { error: useRouteError() }) : void 0;
	if (route.id === "root" && routeModule.Layout) return {
		...Component4 ? { element: /* @__PURE__ */ import_react$14.createElement(routeModule.Layout, null, /* @__PURE__ */ import_react$14.createElement(Component4, null)) } : { Component: Component4 },
		...ErrorBoundary ? { errorElement: /* @__PURE__ */ import_react$14.createElement(routeModule.Layout, null, /* @__PURE__ */ import_react$14.createElement(ErrorBoundary, null)) } : { ErrorBoundary },
		...HydrateFallback ? { hydrateFallbackElement: /* @__PURE__ */ import_react$14.createElement(routeModule.Layout, null, /* @__PURE__ */ import_react$14.createElement(HydrateFallback, null)) } : { HydrateFallback }
	};
	return {
...
function useDataRouterContext2() {
	let context = import_react$12.useContext(DataRouterContext);
	invariant2(context, "You must render this element inside a <DataRouterContext.Provider> element");
	return context;
}
function useDataRouterStateContext() {
	let context = import_react$12.useContext(DataRouterStateContext);
	invariant2(context, "You must render this element inside a <DataRouterStateContext.Provider> element");
	return context;
}
function useFrameworkContext() {
	let context = import_react$12.useContext(FrameworkContext);
	invariant2(context, "You must render this element inside a <HydratedRouter> element");
	return context;
}
function usePrefetchBehavior(prefetch, theirElementProps) {
	let frameworkContext = import_react$12.useContext(FrameworkContext);
	let [maybePrefetch, setMaybePrefetch] = import_react$12.useState(false);
	let [shouldPrefetch, setShouldPrefetch] = import_react$12.useState(false);
	let { onFocus, onBlur, onMouseEnter, onMouseLeave, onTouchStart } = theirElementProps;
	let ref = import_react$12.useRef(null);
...
function Links({ nonce }) {
	...
	let keyedLinks = import_react$12.useMemo(() => getKeyedLinksForMatches(matches, routeModules, manifest), [
		matches,
		routeModules,
		manifest
	]);
	return /* @__PURE__ */ import_react$12.createElement(import_react$12.Fragment, null, typeof criticalCss === "string" ? /* @__PURE__ */ import_react$12.createElement("style", {
		[CRITICAL_CSS_DATA_ATTRIBUTE]: "",
		dangerouslySetInnerHTML: { __html: criticalCss }
	}) : null, typeof criticalCss === "object" ? /* @__PURE__ */ import_react$12.createElement("link", {
		[CRITICAL_CSS_DATA_ATTRIBUTE]: "",
		rel: "stylesheet",
		href: criticalCss.href,
		nonce
	}) : null, keyedLinks.map(({ key, link }) => isPageLinkDescriptor(link) ? /* @__PURE__ */ import_react$12.createElement(PrefetchPageLinks, {
		key,
		nonce,
		...link
	}) : /* @__PURE__ */ import_react$12.createElement("link", {
		key,
		nonce,
		...link
	})));
...
function PrefetchPageLinks({ page, ...linkProps }) {
	...
	let matches = import_react$12.useMemo(() => matchRoutes(router$1.routes, page, router$1.basename), [
		router$1.routes,
		page,
		router$1.basename
	]);
	if (!matches) return null;
	return /* @__PURE__ */ import_react$12.createElement(PrefetchPageLinksImpl, {
		page,
		matches,
		...linkProps
	});
...
function useKeyedPrefetchLinks(matches) {
	...
	let [keyedPrefetchLinks, setKeyedPrefetchLinks] = import_react$12.useState([]);
	import_react$12.useEffect(() => {
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
	...
	let newMatchesForData = import_react$12.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location$1, "data"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	let newMatchesForAssets = import_react$12.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location$1, "assets"), [
		page,
		nextMatches,
		matches,
		manifest,
	...
	let dataHrefs = import_react$12.useMemo(() => {
	...
	let moduleHrefs = import_react$12.useMemo(() => getModuleLinkHrefs(newMatchesForAssets, manifest), [newMatchesForAssets, manifest]);
	let keyedPrefetchLinks = useKeyedPrefetchLinks(newMatchesForAssets);
	return /* @__PURE__ */ import_react$12.createElement(import_react$12.Fragment, null, dataHrefs.map((href$1) => /* @__PURE__ */ import_react$12.createElement("link", {
		key: href$1,
		rel: "prefetch",
		as: "fetch",
		href: href$1,
		...linkProps
	})), moduleHrefs.map((href$1) => /* @__PURE__ */ import_react$12.createElement("link", {
		key: href$1,
		rel: "modulepreload",
		href: href$1,
		...linkProps
	})), keyedPrefetchLinks.map(({ key, link }) => /* @__PURE__ */ import_react$12.createElement("link", {
		key,
...
function Meta() {
	...
	return /* @__PURE__ */ import_react$12.createElement(import_react$12.Fragment, null, meta.flat().map((metaProps) => {
		...
		if ("tagName" in metaProps) {
			...
			let Comp = tagName;
			return /* @__PURE__ */ import_react$12.createElement(Comp, {
				key: JSON.stringify(rest),
				...rest
			});
		}
		if ("title" in metaProps) return /* @__PURE__ */ import_react$12.createElement("title", { key: "title" }, String(metaProps.title));
		if ("charset" in metaProps) {
			metaProps.charSet ?? (metaProps.charSet = metaProps.charset);
			delete metaProps.charset;
		}
		if ("charSet" in metaProps && metaProps.charSet != null) return typeof metaProps.charSet === "string" ? /* @__PURE__ */ import_react$12.createElement("meta", {
			key: "charSet",
			charSet: metaProps.charSet
		}) : null;
		if ("script:ld+json" in metaProps) try {
			let json = JSON.stringify(metaProps["script:ld+json"]);
			return /* @__PURE__ */ import_react$12.createElement("script", {
		...
		return /* @__PURE__ */ import_react$12.createElement("meta", {
...
function Scripts(scriptProps) {
	...
	let initialScripts = import_react$12.useMemo(() => {
...
import(${JSON.stringify(manifest.entry.module)});`;
		return /* @__PURE__ */ import_react$12.createElement(import_react$12.Fragment, null, /* @__PURE__ */ import_react$12.createElement("script", {
			...scriptProps,
			suppressHydrationWarning: true,
			dangerouslySetInnerHTML: { __html: contextScript },
			type: void 0
		}), /* @__PURE__ */ import_react$12.createElement("script", {
			...scriptProps,
			suppressHydrationWarning: true,
	...
	return isHydrated || isRSCRouterContext ? null : /* @__PURE__ */ import_react$12.createElement(import_react$12.Fragment, null, typeof manifest.sri === "object" ? /* @__PURE__ */ import_react$12.createElement("script", {
		"rr-importmap": "",
		type: "importmap",
		suppressHydrationWarning: true,
		dangerouslySetInnerHTML: { __html: JSON.stringify({ integrity: sri }) }
	}) : null, !enableFogOfWar ? /* @__PURE__ */ import_react$12.createElement("link", {
		rel: "modulepreload",
		href: manifest.url,
		crossOrigin: scriptProps.crossOrigin,
		integrity: sri[manifest.url],
		suppressHydrationWarning: true
	}) : null, /* @__PURE__ */ import_react$12.createElement("link", {
		rel: "modulepreload",
		href: manifest.entry.module,
		crossOrigin: scriptProps.crossOrigin,
		integrity: sri[manifest.entry.module],
		suppressHydrationWarning: true
	}), preloads.map((path) => /* @__PURE__ */ import_react$12.createElement("link", {
		key: path,
		rel: "modulepreload",
		href: path,
		crossOrigin: scriptProps.crossOrigin,
...
function RemixRootDefaultErrorBoundary({ error, isOutsideRemixApp }) {
	console.error(error);
	let heyDeveloper = /* @__PURE__ */ import_react$11.createElement("script", { dangerouslySetInnerHTML: { __html: `
        console.log(
          "\u{1F4BF} Hey developer \u{1F44B}. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
        );
      ` } });
	if (isRouteErrorResponse(error)) return /* @__PURE__ */ import_react$11.createElement(BoundaryShell, { title: "Unhandled Thrown Response!" }, /* @__PURE__ */ import_react$11.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
	let errorInstance;
	...
	return /* @__PURE__ */ import_react$11.createElement(BoundaryShell, {
		title: "Application Error!",
		isOutsideRemixApp
	}, /* @__PURE__ */ import_react$11.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ import_react$11.createElement("pre", { style: {
		padding: "2rem",
...
function BoundaryShell({ title, renderScripts, isOutsideRemixApp, children }) {
	...
	return /* @__PURE__ */ import_react$11.createElement("html", { lang: "en" }, /* @__PURE__ */ import_react$11.createElement("head", null, /* @__PURE__ */ import_react$11.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ import_react$11.createElement("meta", {
		name: "viewport",
		content: "width=device-width,initial-scale=1,viewport-fit=cover"
	}), /* @__PURE__ */ import_react$11.createElement("title", null, title)), /* @__PURE__ */ import_react$11.createElement("body", null, /* @__PURE__ */ import_react$11.createElement("main", { style: {
		fontFamily: "system-ui, sans-serif",
		padding: "2rem"
	} }, children, renderScripts ? /* @__PURE__ */ import_react$11.createElement(Scripts, null) : null)));
}
...
function BrowserRouter({ basename, children, window: window2 }) {
	let historyRef = import_react$16.useRef();
	if (historyRef.current == null) historyRef.current = createBrowserHistory({
		window: window2,
		v5Compat: true
	});
	let history = historyRef.current;
	let [state, setStateImpl] = import_react$16.useState({
		action: history.action,
		location: history.location
	});
	let setState = import_react$16.useCallback((newState) => {
		import_react$16.startTransition(() => setStateImpl(newState));
	}, [setStateImpl]);
	import_react$16.useLayoutEffect(() => history.listen(setState), [history, setState]);
	return /* @__PURE__ */ import_react$16.createElement(Router, {
		basename,
		children,
		location: state.location,
		navigationType: state.action,
...
function ScrollRestoration({ getKey, storageKey, ...props }) {
	let remixContext = import_react$16.useContext(FrameworkContext);
	let { basename } = import_react$16.useContext(NavigationContext);
	let location$1 = useLocation();
	...
	let ssrKey = import_react$16.useMemo(() => {
	...
	return /* @__PURE__ */ import_react$16.createElement("script", {
		...props,
		suppressHydrationWarning: true,
...
function useDataRouterContext3(hookName) {
	let ctx = import_react$16.useContext(DataRouterContext);
	invariant(ctx, getDataRouterConsoleError2(hookName));
	return ctx;
}
function useDataRouterState2(hookName) {
	let state = import_react$16.useContext(DataRouterStateContext);
...
function useLinkClickHandler(to, { target, replace: replaceProp, state, preventScrollReset, relative, viewTransition } = {}) {
	...
	return import_react$16.useCallback((event) => {
...
function useSearchParams(defaultInit) {
	...
	let defaultSearchParamsRef = import_react$16.useRef(createSearchParams(defaultInit));
	let hasSetSearchParamsRef = import_react$16.useRef(false);
	let location$1 = useLocation();
	let searchParams = import_react$16.useMemo(() => getSearchParamsForLocation(location$1.search, hasSetSearchParamsRef.current ? null : defaultSearchParamsRef.current), [location$1.search]);
	let navigate = useNavigate();
	return [searchParams, import_react$16.useCallback((nextInit, navigateOptions) => {
...
function useSubmit() {
	...
	return import_react$16.useCallback(async (target, options = {}) => {
...
function useFormAction(action, { relative } = {}) {
	let { basename } = import_react$16.useContext(NavigationContext);
	let routeContext = import_react$16.useContext(RouteContext);
...
function useFetcher({ key } = {}) {
	...
	let fetcherData = import_react$16.useContext(FetchersContext);
	let route = import_react$16.useContext(RouteContext);
	...
	let defaultKey = import_react$16.useId();
	let [fetcherKey, setFetcherKey] = import_react$16.useState(key || defaultKey);
	...
	let load = import_react$16.useCallback(async (href$1, opts) => {
	...
	let submit = import_react$16.useCallback(async (target, opts) => {
	...
	let unstable_reset = import_react$16.useCallback((opts) => router$1.resetFetcher(fetcherKey, opts), [router$1, fetcherKey]);
	let FetcherForm = import_react$16.useMemo(() => {
		let FetcherForm2 = import_react$16.forwardRef((props, ref) => {
			return /* @__PURE__ */ import_react$16.createElement(Form, {
				...props,
				navigate: false,
				fetcherKey,
				ref
	...
	return import_react$16.useMemo(() => ({
		Form: FetcherForm,
		submit,
		load,
		unstable_reset,
...
function useScrollRestoration({ getKey, storageKey } = {}) {
	...
	usePageHide(import_react$16.useCallback(() => {
	...
	if (typeof document !== "undefined") {
		import_react$16.useLayoutEffect(() => {
			try {
...
function useViewTransitionState(to, { relative } = {}) {
	let vtContext = import_react$16.useContext(ViewTransitionContext);
...
function StaticRouterProvider({ context, router: router$1, hydrate: hydrate2 = true, nonce }) {
	...
	return /* @__PURE__ */ import_react$17.createElement(import_react$17.Fragment, null, /* @__PURE__ */ import_react$17.createElement(DataRouterContext.Provider, { value: dataRouterContext }, /* @__PURE__ */ import_react$17.createElement(DataRouterStateContext.Provider, { value: state }, /* @__PURE__ */ import_react$17.createElement(FetchersContext.Provider, { value: fetchersContext }, /* @__PURE__ */ import_react$17.createElement(ViewTransitionContext.Provider, { value: { isTransitioning: false } }, /* @__PURE__ */ import_react$17.createElement(Router, {
		basename: dataRouterContext.basename,
		location: state.location,
		navigationType: state.historyAction,
		navigator: dataRouterContext.navigator,
		static: dataRouterContext.static
	}, /* @__PURE__ */ import_react$17.createElement(DataRoutes2, {
		routes: router$1.routes,
		future: router$1.future,
		state
	})))))), hydrateScript ? /* @__PURE__ */ import_react$17.createElement("script", {
		suppressHydrationWarning: true,
		nonce,
...
var init_chunk_4WY6JWTD = __esm({ "node_modules/react-router/dist/development/chunk-4WY6JWTD.mjs": (() => {
	...
	DataRouterContext = import_react$7.createContext(null);
	DataRouterContext.displayName = "DataRouter";
	DataRouterStateContext = import_react$7.createContext(null);
	DataRouterStateContext.displayName = "DataRouterState";
	RSCRouterContext = import_react$7.createContext(false);
	ViewTransitionContext = import_react$7.createContext({ isTransitioning: false });
	ViewTransitionContext.displayName = "ViewTransition";
	FetchersContext = import_react$7.createContext(/* @__PURE__ */ new Map());
	FetchersContext.displayName = "Fetchers";
	AwaitContext = import_react$7.createContext(null);
	AwaitContext.displayName = "Await";
	AwaitContextProvider = (props) => import_react$7.createElement(AwaitContext.Provider, props);
	NavigationContext = import_react$7.createContext(null);
	NavigationContext.displayName = "Navigation";
	LocationContext = import_react$7.createContext(null);
	LocationContext.displayName = "Location";
	RouteContext = import_react$7.createContext({
		outlet: null,
		matches: [],
		isDataRoute: false
	});
	RouteContext.displayName = "Route";
	RouteErrorContext = import_react$7.createContext(null);
	...
	OutletContext = import_react$8.createContext(null);
	defaultErrorElement = /* @__PURE__ */ import_react$8.createElement(DefaultErrorComponent, null);
	RenderErrorBoundary = class extends import_react$8.Component {
		constructor(props) {
			super(props);
			this.state = {
		...
		render() {
			return this.state.error !== void 0 ? /* @__PURE__ */ import_react$8.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ import_react$8.createElement(RouteErrorContext.Provider, {
	...
	MemoizedDataRoutes = import_react$9.memo(DataRoutes);
	AwaitErrorBoundary = class extends import_react$9.Component {
		constructor(props) {
			super(props);
		...
		render() {
			...
			if (status === 2) return /* @__PURE__ */ import_react$9.createElement(AwaitContext.Provider, {
				value: promise,
				children: errorElement
			});
			if (status === 1) return /* @__PURE__ */ import_react$9.createElement(AwaitContext.Provider, {
				value: promise,
				children
			});
			throw promise;
	...
	FrameworkContext = import_react$12.createContext(void 0);
	FrameworkContext.displayName = "FrameworkContext";
	CRITICAL_CSS_DATA_ATTRIBUTE = "data-react-router-critical-css";
	isHydrated = false;
	RemixErrorBoundary = class extends import_react$11.Component {
		constructor(props) {
			super(props);
			this.state = {
		...
		render() {
			if (this.state.error) return /* @__PURE__ */ import_react$11.createElement(RemixRootDefaultErrorBoundary, {
	...
	Link = import_react$16.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, state, target, to, preventScrollReset, viewTransition, ...rest }, forwardedRef) {
		let { basename } = import_react$16.useContext(NavigationContext);
		...
		let link = /* @__PURE__ */ import_react$16.createElement("a", {
			...rest,
			...prefetchHandlers,
		...
		return shouldPrefetch && !isAbsolute ? /* @__PURE__ */ import_react$16.createElement(import_react$16.Fragment, null, link, /* @__PURE__ */ import_react$16.createElement(PrefetchPageLinks, { page: href$1 })) : link;
	});
	Link.displayName = "Link";
	NavLink = import_react$16.forwardRef(function NavLinkWithRef({ "aria-current": ariaCurrentProp = "page", caseSensitive = false, className: classNameProp = "", end = false, style: styleProp, to, viewTransition, children, ...rest }, ref) {
		let path = useResolvedPath(to, { relative: rest.relative });
		let location$1 = useLocation();
		let routerState = import_react$16.useContext(DataRouterStateContext);
		let { navigator, basename } = import_react$16.useContext(NavigationContext);
		...
		return /* @__PURE__ */ import_react$16.createElement(Link, {
			...rest,
	...
	Form = import_react$16.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, ...props }, forwardedRef) => {
...
function ServerRouter({ context, url, nonce }) {
	...
	return /* @__PURE__ */ import_react$3.createElement(import_react$3.Fragment, null, /* @__PURE__ */ import_react$3.createElement(FrameworkContext.Provider, { value: {
		manifest,
		routeModules,
		criticalCss,
		serverHandoffString,
	...
	} }, /* @__PURE__ */ import_react$3.createElement(RemixErrorBoundary, { location: router$1.state.location }, /* @__PURE__ */ import_react$3.createElement(StaticRouterProvider, {
		router: router$1,
		context: context.staticHandlerContext,
		hydrate: false
	}))), context.serverHandoffStream ? /* @__PURE__ */ import_react$3.createElement(import_react$3.Suspense, null, /* @__PURE__ */ import_react$3.createElement(StreamTransfer, {
		context,
		identifier: 0,
...
function createRoutesStub(routes, _context) {
	return function RoutesTestStub({ initialEntries, initialIndex, hydrationData, future }) {
		let routerRef = import_react$4.useRef();
		let frameworkContextRef = import_react$4.useRef();
		...
		return /* @__PURE__ */ import_react$4.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ import_react$4.createElement(RouterProvider, { router: routerRef.current }));
	};
}
...
function ErrorWrapper({ renderAppShell, title, children }) {
	...
	return /* @__PURE__ */ import_react$6.createElement("html", { lang: "en" }, /* @__PURE__ */ import_react$6.createElement("head", null, /* @__PURE__ */ import_react$6.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ import_react$6.createElement("meta", {
		name: "viewport",
		content: "width=device-width,initial-scale=1,viewport-fit=cover"
	}), /* @__PURE__ */ import_react$6.createElement("title", null, title)), /* @__PURE__ */ import_react$6.createElement("body", null, /* @__PURE__ */ import_react$6.createElement("main", { style: {
		fontFamily: "system-ui, sans-serif",
		padding: "2rem"
	} }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({ error, renderAppShell }) {
	console.error(error);
	let heyDeveloper = /* @__PURE__ */ import_react$6.createElement("script", { dangerouslySetInnerHTML: { __html: `
        console.log(
          "\u{1F4BF} Hey developer \u{1F44B}. You can provide a way better UX than this when your app throws errors. Check out https://reactrouter.com/how-to/error-boundary for more information."
        );
      ` } });
	if (isRouteErrorResponse(error)) return /* @__PURE__ */ import_react$6.createElement(ErrorWrapper, {
		renderAppShell,
		title: "Unhandled Thrown Response!"
	}, /* @__PURE__ */ import_react$6.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
	let errorInstance;
	if (error instanceof Error) errorInstance = error;
	else {
		let errorString = error == null ? "Unknown Error" : typeof error === "object" && "toString" in error ? error.toString() : JSON.stringify(error);
	...
	return /* @__PURE__ */ import_react$6.createElement(ErrorWrapper, {
		renderAppShell,
		title: "Application Error!"
	}, /* @__PURE__ */ import_react$6.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ import_react$6.createElement("pre", { style: {
		padding: "2rem",
		background: "hsla(10, 50%, 50%, 0.1)",
		color: "red",
		overflow: "auto"
...
function RSCDefaultRootErrorBoundary({ hasRootLayout }) {
	...
	return /* @__PURE__ */ import_react$6.createElement(RSCDefaultRootErrorBoundaryImpl, {
...
function RSCStaticRouter({ getPayload }) {
	...
	return /* @__PURE__ */ import_react$5.createElement(RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ import_react$5.createElement(RSCRouterGlobalErrorBoundary, { location: payload.location }, /* @__PURE__ */ import_react$5.createElement(FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ import_react$5.createElement(StaticRouterProvider, {
		context,
		router: router$1,
		hydrate: false,
		nonce: payload.nonce
...
var import_react$3, import_react$4, import_dist, import_set_cookie, import_react$5, import_react$6, encoder, sign, unsign, createKey, createCookie, isCookie, ServerMode, globalDevServerHooksKey, SERVER_NO_BODY_STATUS_CODES, createRequestHandler, createSession, isSession, encoder2, trailer, RSCRouterGlobalErrorBoundary, noopComponent, useImpl;
var init_chunk_G3INQAYP = __esm({ "node_modules/react-router/dist/development/chunk-G3INQAYP.mjs": (() => {
	init_chunk_4WY6JWTD();
	...
	trailer = "</body></html>";
	RSCRouterGlobalErrorBoundary = class extends import_react$6.Component {
		constructor(props) {
			super(props);
			this.state = {
				error: null,
		...
		render() {
			if (this.state.error) return /* @__PURE__ */ import_react$6.createElement(RSCDefaultRootErrorBoundaryImpl, {
				error: this.state.error,
				renderAppShell: true
			});
			else return this.props.children;
...
* @license MIT
*/
var dom_export_exports = /* @__PURE__ */ __export({
...
function HydratedRouter(props) {
	...
	let [criticalCss, setCriticalCss] = import_react$1.useState(ssrInfo?.context.criticalCss);
	...
	let [location2, setLocation] = import_react$1.useState(router.state.location);
	...
	return /* @__PURE__ */ import_react$1.createElement(import_react$1.Fragment, null, /* @__PURE__ */ import_react$1.createElement(FrameworkContext.Provider, { value: {
	...
	} }, /* @__PURE__ */ import_react$1.createElement(RemixErrorBoundary, { location: location2 }, /* @__PURE__ */ import_react$1.createElement(RouterProvider2, {
		router,
		unstable_onError: props.unstable_onError
	}))), /* @__PURE__ */ import_react$1.createElement(import_react$1.Fragment, null));
}
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
	return async (args, basename, targetRoutes) => {
		...
		try {
			...
			for (let [routeId, data$1] of Object.entries(payload[dataKey] || {})) results.routes[routeId] = { data: data$1 };
...
function RSCHydratedRouter({ createFromReadableStream, fetch: fetchImplementation = fetch, payload, routeDiscovery = "eager", getContext }) {
	if (payload.type !== "render") throw new Error("Invalid payload type");
	let { router: router2, routeModules } = import_react$2.useMemo(() => createRouterFromPayload({
		payload,
		fetchImplementation,
		getContext,
	...
	let [location2, setLocation] = import_react$2.useState(router2.state.location);
	import_react$2.useLayoutEffect(() => router2.subscribe((newState) => {
		if (newState.location !== location2) setLocation(newState.location);
	}), [router2, location2]);
	import_react$2.useEffect(() => {
	...
	return /* @__PURE__ */ import_react$2.createElement(RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ import_react$2.createElement(RSCRouterGlobalErrorBoundary, { location: location2 }, /* @__PURE__ */ import_react$2.createElement(FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ import_react$2.createElement(UNSTABLE_TransitionEnabledRouterProvider, {
		router: router2,
...
function getRSCStream() {
	let encoder$1 = new TextEncoder();
	let streamController = null;
	let rscStream = new ReadableStream({ start(controller) {
		if (typeof window === "undefined") return;
		let handleChunk = (chunk) => {
			if (typeof chunk === "string") controller.enqueue(encoder$1.encode(chunk));
...
var import_react, import_react_dom, import_react$1, import_react$2, import_react_dom$1, ssrInfo, router, renderedRoutesContext, nextPaths, discoveredPathsMaxSize, discoveredPaths, URL_LIMIT;
var init_dom_export = __esm({ "node_modules/react-router/dist/development/dom-export.mjs": (() => {
	init_chunk_G3INQAYP();
	init_chunk_4WY6JWTD();
	...
	ssrInfo = null;
	router = null;
	renderedRoutesContext = createContext();
...
* @license MIT
*/
var development_exports = /* @__PURE__ */ __export({
	Await: () => Await,
...
var init_development = __esm({ "node_modules/react-router/dist/development/index.mjs": (() => {
	init_chunk_G3INQAYP();
	init_chunk_4WY6JWTD();
}) });

//#endregion
export { Router as $, useInRouterContext as $t, DataRouterStateContext as A, hydrationRouteProperties as At, Link as B, replace as Bt, routeRSCServerRequest as C, withErrorBoundaryProps as Cn, createStaticHandler2 as Ct, AwaitContextProvider as D, generatePath as Dt, Await as E, decodeViaTurboStream as Et, HashRouter as F, matchRoutes as Ft, NavLink as G, useAsyncValue as Gt, LocationContext as H, shouldHydrateRouteLoader as Ht, HistoryRouter as I, parsePath as It, Outlet as J, useFetcher as Jt, Navigate as K, useBeforeUnload as Kt, IDLE_BLOCKER as L, redirect as Lt, FetchersContext as M, isRouteErrorResponse as Mt, Form as N, mapRouteProperties as Nt, BrowserRouter as O, getPatchRoutesOnNavigationFunction as Ot, FrameworkContext as P, matchPath as Pt, RouteContext as Q, useHref as Qt, IDLE_FETCHER as R, redirectDocument as Rt, isSession as S, withComponentProps as Sn, createSearchParams as St, Action as T, data as Tt, MemoryRouter as U, useActionData as Ut, Links as V, resolvePath as Vt, Meta as W, useAsyncError as Wt, RemixErrorBoundary as X, useFogOFWarDiscovery as Xt, PrefetchPageLinks as Y, useFetchers as Yt, Route as Z, useFormAction as Zt, createSessionStorage as _, useRoutes as _n, createMemoryRouter as _t, dom_export_exports as a, useNavigate as an, StaticRouter as at, href as b, useSubmit as bn, createRoutesFromChildren as bt, RSCStaticRouter as c, useOutlet as cn, WithComponentProps as ct, createCookie as d, usePrompt as dn, createBrowserHistory as dt, useLinkClickHandler as en, RouterContextProvider as et, createCookieSessionStorage as f, useResolvedPath as fn, createBrowserRouter as ft, createSession as g, useRouteLoaderData as gn, createHashRouter as gt, createRoutesStub as h, useRouteError as hn, createContext as ht, RouterProvider2 as i, useMatches as in, SingleFetchRedirectSymbol as it, ErrorResponseImpl as j, invariant as jt, DataRouterContext as k, getTurboStreamSingleFetchDataStrategy as kt, ServerMode as l, useOutletContext as ln, WithErrorBoundaryProps as lt, createRequestHandler as m, useRoute as mn, createClientRoutesWithHMRRevalidationOptOut as mt, init_development as n, useLocation as nn, Scripts as nt, init_dom_export as o, useNavigation as on, StaticRouterProvider as ot, createMemorySessionStorage as p, useRevalidator as pn, createClientRoutes as pt, NavigationContext as q, useBlocker as qt, HydratedRouter as r, useMatch as rn, ScrollRestoration as rt, RSCDefaultRootErrorBoundary as s, useNavigationType as sn, ViewTransitionContext as st, development_exports as t, useLoaderData as tn, Routes as tt, ServerRouter as u, useParams as un, WithHydrateFallbackProps as ut, deserializeErrors as v, useScrollRestoration as vn, createPath as vt, setDevServerHooks as w, withHydrateFallbackProps as wn, createStaticRouter as wt, isCookie as x, useViewTransitionState as xn, createRoutesFromElements as xt, getHydrationData as y, useSearchParams as yn, createRouter as yt, IDLE_NAVIGATION as z, renderMatches as zt };
//# sourceMappingURL=development-BTPRSGsq.js.map